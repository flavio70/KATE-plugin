 ...
 */
@Extension
public class JobDevelopment extends UIKate {

    @Override
    public String getDescription() {
        return "Test selection for dynamic Job development";
    }
